...
import { httpHello3 } from '../src/functions/index';

describe('httpHello3 function', () => {
  ...
  it('should return "Hello, world!" when no name is provided', async () => {
    const result = await httpHello3(mockRequest as any, mockContext as any);
  ...
  it('should return "Hello, Bob!" when the name is provided in the body', async () => {
    ...
    const result = await httpHello3(mockRequest as HttpRequest, mockContext as InvocationContext);
